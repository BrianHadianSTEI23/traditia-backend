...
import { create, getAll, getById, updateById, deleteById, deleteByEthnicId, updateByEthnicId, getByEthnicId, getByName} from "../controllers/traditional-dance.controller.js"
...
traditionDanceRouter.get('/tradition-dance/:name', getByName);
